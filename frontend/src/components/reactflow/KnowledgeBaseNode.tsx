...
export const KnowledgeBaseNode = ({
  ...
  console.log("KnowledgeBaseNode data:", data);
        ...
        <CardContent className="flex flex-col gap-2 text-sm">
          <div className="flex items-center gap-2">
            ...
            <Input
              ...
              onChange={(e) =>
                !data.readOnly &&
                data.onDataChange?.(id, "embedding_model_name", e.target.value)
              }
            />
          </div>
          <div className="flex items-center gap-2">
          ...
          {!data.readOnly && (
            <div className="flex flex-col gap-2">
              <Label>Upload Files({data?.files_to_upload?.length}):</Label>
              <div className="flex items-center gap-2">
                <input
                  ref={fileInputRef}
                  type="file"
          ...
          {data.files_to_upload && data.files_to_upload.length > 0 && (
            <div className="flex flex-col gap-2">
          ...
          {data.pdf_files && data.pdf_files.length > 0 && (
            <div className="flex flex-col gap-2">
              <Label className="text-sm font-medium">
                {data.readOnly ? "Files:" : "Select Files to Delete:"}
              </Label>
