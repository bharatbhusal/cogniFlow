...
class KnowledgeBaseService:
    def __init__(self):
        ...
        try:
            ...
            raise ChromaDBError(message="Failed to initialize ChromaDB", details=str(e))
    ...
    def _get_or_create_collection(self):
        ...
        try:
            ...
            raise ChromaDBError(
                message="Failed to create/access ChromaDB collection", details=str(e)
            )
    ...
    async def extract_text_from_pdf_memory(self, content: bytes) -> tuple[str, int]:
        ...
        try:
            ...
            if isinstance(e, TextExtractionError):
                raise
            raise TextExtractionError(
                message="Failed to extract text from PDF", details=str(e)
            )
    ...
    def chunk_text_recursively(
        ...
        try:
                    ...
                    if len(current_chunk + split) <= chunk_size:
                        ...
                        if len(split) > chunk_size:
                            result_chunks.extend(
                                _split_text(split, remaining_separators, chunk_size)
                            )
                        else:
                            current_chunk = split
            ...
            raise ChunkingError(message="Text chunking failed", details=str(e))
    ...
    async def store_chunks_in_vectordb(
        ...
        try:
            ...
            raise VectorStoreError(
                message="Failed to store chunks in vector database", details=str(e)
            )
    ...
    async def retrieve_relevant_context(
        ...
        try:
                    ...
                    context_chunks.append(
                        {
                            ...
                            "source": (
                                results["metadatas"][0][i].get("filename", "unknown")
                                if results["metadatas"]
                                else "unknown"
                            ),
                            "document_id": (
                                results["metadatas"][0][i].get("document_id", "unknown")
                                if results["metadatas"]
                                else "unknown"
                            ),
                        }
            ...
            raise ContextRetrievalError(
                message="Failed to retrieve relevant context", details=str(e)
            )

    async def retrieve_relevant_context_by_ids(
        self, query: str, n_results: int = 5, chromadb_chunk_ids: List[str] = None
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise ContextRetrievalError(
                message="Failed to retrieve relevant context by IDs", details=str(e)
            )
    ...
    async def get_project_status(self, project_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RetrievalError(message="Failed to get project status", details=str(e))
    ...
    async def get_project_documents(self, project_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise RetrievalError(
                message="Failed to get project documents", details=str(e)
            )
    ...
    async def get_document_status(self, document_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RetrievalError(
                message="Failed to get document status", details=str(e)
            )
    ...
    async def delete_project(self, project_id: str) -> bool:
        ...
        try:
            ...
            raise VectorStoreError(message="Failed to delete project", details=str(e))
    ...
    def delete_document(self, document_id: str) -> bool:
        ...
        try:
            ...
            raise VectorStoreError(message="Failed to delete document", details=str(e))
